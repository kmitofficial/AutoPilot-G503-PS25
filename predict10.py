...
def run_prediction():
    ...
    # ---- START OF NEW CODE (EDIT 1) ----
    prediction_count = 0
    # ---- END OF NEW CODE (EDIT 1) ----
    for scene in selected_scenes:
        ...
        for i in range(0, num_frames - TTL_LEN, 1):
            try:
                ...
                # ---- START OF NEW CODE (EDIT 2) ----
                prediction_count += 1
                print(f"--- Prediction {prediction_count}/10 completed. ---")
                if prediction_count >= 10:
                    break
                # ---- END OF NEW CODE (EDIT 2) ----
        ...
        # ---- START OF NEW CODE (EDIT 3) ----
        if prediction_count >= 10:
            break
        # ---- END OF NEW CODE (EDIT 3) ----
